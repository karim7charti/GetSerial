...
class NewProductsAll extends Component{
     state={
        products:[],
        loading:true,
    }
    componentDidMount() {
         axios.get('api/lastProducts').then(res=>{
        ...
        return (
            ...
            <div className="col-lg-4 col-md-4 col-sm-10 col-10 my-2 mx-auto p-2  Preview">
                   <div className="row">
                     ...
                     <div className="col-12 col-lg-11 col-md-12 col-sm-12 mt-2 mx-3"><b>Last products</b></div>
